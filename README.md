...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the crm-channel-gateway public boundary. It mus
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-channel-gateway-filament?sort=semver)](https://github.com/liberusoftware/module-crm-channel-gateway-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-channel-gateway-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-channel-gateway-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-channel-gateway-filament
```
...
<a href="https://github.com/liberusoftware/module-crm-channel-gateway-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-channel-gateway-filament" alt="Contributors to liberusoftware/module-crm-channel-gateway-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-channel-gateway-filament/graphs/contributors).
